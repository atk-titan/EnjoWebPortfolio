...
const Page2 = () => {
  ...
  return (
    <div id="page2" className='w-full bg-white px-24 py-6 text-black flex flex-col items-center'>
        <h5 className='text-[25px] font-[anzo3]'>©  anzo.studio 2024 | designed and developed</h5>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo4] h-[content-fit] leading-[33vw] mt-[12vh]'>IMPACTFUL</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo4] h-[content-fit] leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo4] h-[content-fit] leading-[33vw]'>IS THE</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo4] h-[content-fit] leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo4] h-[content-fit] leading-[33vw]'>THAT</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo4] h-[content-fit] leading-[33vw]'>WORKS!</h1>
        </div>

        <div className='flex items-centre h-[content-fit] m-14'>
            <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="48" width="57vw" data-type="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio ">
    <g>
        ...
        <div className='border-t-[2px] border-black w-[27vw] h-1 m-11'>
        </div>
    </div>
  );
}
